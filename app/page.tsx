...
const personalProjects = [
  ...
  { icon: "🌡️", name: "홈 IoT 대시보드", desc: "라즈베리파이 기반 온습도 센서 + 외부 날씨 API 연동 대시보드. 주식 크롤링 데이터까지 통합한 개인 홈 모니터링 시스템. 엣지컴퓨팅 기반 무비용 운영.", tags: ["Node.js", "IoT", "Raspberry Pi", "크롤링"], link: "https://msk-dashboard.vercel.app/", linkText: "대시보드 바로가기 →", accent: "#00d4aa" },
